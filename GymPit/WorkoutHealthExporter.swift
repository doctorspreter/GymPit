...
final class WorkoutHealthExporter {
    ...
    func save(_ session: WorkoutSession, completion: @escaping (Result<Void, Error>) -> Void) {
    ...
    private func saveAuthorized(_ session: WorkoutSession, completion: @escaping (Result<Void, Error>) -> Void) {
