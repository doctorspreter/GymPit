...
enum ExerciseCatalog {
    static let all: [ExerciseCatalogItem] = [
        ...
        item("push-up", "Liegestütze", .chest, "3 x 12", 3, 12, 0, 4.0, "Körpergewicht", "-", "-", "Schulterbreit", "Voll"),
        ...
        item("front-raise", "Frontheben", .shoulders, "3 x 10-12", 3, 12, 12.5, 4.0, "Kurzhantel", "-", "-", "Neutral", "Bis Schulterhöhe"),
        item("shrug-machine", "Shrug Maschine", .shoulders, "3 x 10-12", 3, 12, 60, 4.5, "Shrug Machine", "Stand", "-", "Neutral", "Oben halten"),
        item("arnold-press", "Arnold Press", .shoulders, "3 x 8-10", 3, 10, 17.5, 5.0, "Kurzhantel", "Bank", "80 Grad", "Neutral", "Kontrolliert"),
        ...
        item("hammer-curl", "Hammercurl", .arms, "3 x 10-12", 3, 12, 15, 4.0, "Kurzhantel", "-", "-", "Neutral", "Voll"),
        ...
        item("skull-crusher", "Skull Crusher", .arms, "3 x 8-10", 3, 10, 25, 4.0, "SZ-Stange", "Bank", "-", "Eng", "Kontrolliert"),
        ...
        item("plank", "Plank", .core, "3 x 45 s", 3, 45, 0, 3.5, "Matte", "-", "-", "-", "Stabil"),
        ...
        item("bench-press", "Bankdrücken", .freeWeights, "3 x 5-8", 3, 8, 60, 6.0, "Langhantel", "Bank flach", "-", "Breit", "Brust berühren"),
        item("squat", "Kniebeuge", .freeWeights, "3 x 5-8", 3, 8, 80, 6.0, "Rack", "J-Hooks", "Safety Bars", "Langhantel", "Tief stabil"),
        item("deadlift", "Kreuzheben", .freeWeights, "3 x 5", 3, 5, 90, 6.0, "Plattform", "-", "-", "Langhantel", "Neutral"),
        item("dumbbell-row", "Kurzhantelrudern", .freeWeights, "3 x 10 je Seite", 3, 10, 25, 5.0, "Kurzhantel", "Bank", "-", "Neutral", "Voll"),
        item("romanian-deadlift", "Rumänisches Kreuzheben", .freeWeights, "3 x 8-10", 3, 10, 70, 5.5, "Langhantel", "-", "-", "Obergriff", "Bis Dehnung"),
        item("goblet-squat", "Goblet Squat", .freeWeights, "3 x 10-12", 3, 12, 25, 5.0, "Kettlebell", "-", "-", "Vor Brust", "Tief"),
        item("walking-lunge", "Ausfallschritte gehend", .freeWeights, "3 x 12 je Seite", 3, 12, 20, 5.5, "Kurzhantel", "-", "-", "Neutral", "Kontrolliert"),
        item("dumbbell-bench-press", "Kurzhantel Bankdrücken", .freeWeights, "3 x 8-10", 3, 10, 25, 5.5, "Kurzhantel", "Bank flach", "-", "Neutral", "Voll")
    ]
